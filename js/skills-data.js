...
const skillsData = {
  ...
  skills: [
    ...
    { name: 'ISO 56000 series',         category: 'management', level: 90, years: 8,  status: 'consolidated',
    ...
    { name: 'Multi-year Roadmaps',      category: 'management', level: 85, years: 6,  status: 'consolidated',
      evidence: ['AdP multi-horizon roadmaps (short/medium/long)'] },
    { name: 'Operating Models',         category: 'management', level: 85, years: 8,  status: 'consolidated',
      evidence: ['Built AdP innovation from scratch', 'SmartEnergyLab governance'] },
    { name: 'Business Case Construction', category: 'management', level: 85, years: 12, status: 'consolidated',
      evidence: ['AdP innovation cases', 'M&A Lanco / Martifer'] },
    { name: 'Financial Modelling',      category: 'management', level: 80, years: 12, status: 'consolidated',
      evidence: ['Multi-scale (M&A → pilot)', 'Lanco/Martifer DD'] },
    { name: 'Team Building',            category: 'management', level: 80, years: 8,  status: 'consolidated',
      evidence: ['Innovation teams from scratch at AdP'] },
    { name: 'Process Optimization',     category: 'management', level: 80, years: 8,  status: 'consolidated',
      evidence: ['AdP Group process owners', 'Simplification + automation'] },
    { name: 'Public Sector',            category: 'management', level: 80, years: 15, status: 'consolidated',
      evidence: ['Águas de Portugal', 'IPAC', 'INTELI'] },
    { name: 'Private Sector',           category: 'management', level: 80, years: 15, status: 'consolidated',
      evidence: ['Sonae Sierra', 'Martifer', 'Lanco Solar', 'CEiiA'] },
    { name: 'M&A Due Diligence',        category: 'management', level: 75, years: 6,  status: 'consolidated',
      evidence: ['Lanco Solar (1 M&A)', 'Martifer PV + wind acquisitions'] },
    { name: 'Procurement (PT/EU/B2B)',  category: 'management', level: 75, years: 10, status: 'consolidated',
      evidence: ['Portuguese CCP', 'EU contracting', 'B2B deals'] },
    { name: 'Senior Hiring',            category: 'management', level: 75, years: 5,  status: 'learning',
      evidence: ['AdP VALOR competency framework', 'Track record of strong placements'] },
    { name: 'KPI Design',               category: 'management', level: 75, years: 8,  status: 'consolidated',
      evidence: ['AdP innovation governance', 'CEiiA indicators'] },
    { name: 'Compliance Frameworks',    category: 'management', level: 75, years: 8,  status: 'consolidated',
      evidence: ['IPAC ISO 56002 / NP 4457'] },
    { name: 'Cross-border Operations',  category: 'management', level: 75, years: 10, status: 'consolidated',
      evidence: ['PT, IT, UK teams across Lanco, Martifer, Sonae'] },
    { name: 'Contract Negotiation',     category: 'management', level: 70, years: 12, status: 'consolidated',
      evidence: ['Lanco complex deals', 'Martifer EPC + O&M'] },
    { name: 'Strategic Intelligence',   category: 'management', level: 75, years: 4,  status: 'learning',
      evidence: ['SmartEnergyLab methodology for major utility'] },

    // ===== STEM (10) =====
    { name: 'Environmental Engineering', category: 'stem', level: 75, years: 20, status: 'consolidated',
      evidence: ['Graduate degree — University of Aveiro (1995-2002)', 'Air pollution specialisation', 'Sonae Sierra EMS work'] },
    { name: 'Energy Systems',           category: 'stem', level: 85, years: 18, status: 'consolidated',
      evidence: ['INTELI Energy Programme', 'Martifer renewables', 'Lanco Solar utility-scale PV', 'SmartEnergyLab CoLAB'] },
    { name: 'Sustainability (GHG/LCA/EMS)', category: 'stem', level: 75, years: 15, status: 'consolidated',
      evidence: ['Enerdinâmica GHG mitigation plan', 'Sonae Sierra EMS rep', 'WWF One Planet Living'] },
    { name: 'Combustion / Biomass science', category: 'stem', level: 65, years: 8, status: 'consolidated',
    ...
    { name: 'Technical Due Diligence (energy)', category: 'stem', level: 75, years: 6, status: 'consolidated',
      evidence: ['Lanco Solar 600MW DD', 'Martifer PV/wind technical DD', 'Power curve + park layout optimisation'] },
    { name: 'Scientific Writing',       category: 'stem', level: 60, years: 8, status: 'learning',
      evidence: ['Co-authored Cosmi et al. 2014 (WIT Transactions)', 'Master\'s dissertation', 'PhD research papers in progress'] },
    { name: 'Statistical thinking',     category: 'stem', level: 55, years: 4, status: 'learning',
      evidence: ['Lisbon Data Science Academy', 'PhD research methods'] },
    { name: 'Data Science',             category: 'stem', level: 65, years: 4, status: 'learning',
      evidence: ['Lisbon Data Science Academy — Batch #5', 'PhD NOVA IMS'] },
    { name: 'Soil & Plant Analysis',    category: 'stem', level: 40, years: 1, status: 'consolidated',
      evidence: ['Short postgrad — Wageningen University (1999-2000)', 'Erasmus exchange'] },

    // ===== DIGITAL (15) =====
    { name: 'GenAI / LLM integration',  category: 'digital', level: 80, years: 2, status: 'learning', consolidatedLevel: 40,
      evidence: ['AdP VALOR — embed AI into operations', 'Daily Claude/MCP work', 'Agentic workflows'] },
    { name: 'MCP / Agentic workflows',  category: 'digital', level: 75, years: 1, status: 'learning', consolidatedLevel: 15,
      evidence: ['Current AdP work', 'CV explicit', 'Active experimentation'] },
    { name: 'Prompt engineering',       category: 'digital', level: 75, years: 2, status: 'learning', consolidatedLevel: 50,
      evidence: ['Daily Claude / LLM work', 'Innovation workflow design'] },
    { name: 'Innovation tooling (Notion/Asana/Miro)', category: 'digital', level: 80, years: 5, status: 'consolidated',
      evidence: ['AdP VALOR innovation stack', 'CEiiA portfolio tools'] },
    { name: 'ERP integration (SAP)',    category: 'digital', level: 65, years: 8, status: 'consolidated',
      evidence: ['AdP VALOR ERP + collab stack', 'Sonae Sierra processes'] },
    { name: 'Python',                   category: 'digital', level: 70, years: 5, status: 'learning', consolidatedLevel: 50,
      evidence: ['Le Wagon Full Stack Bootcamp', 'Lisbon Data Science Academy', 'AdP VALOR pipelines'] },
    { name: 'HTML / CSS / JS',          category: 'digital', level: 65, years: 5, status: 'learning', consolidatedLevel: 45,
      evidence: ['This portfolio site (active build)', 'Le Wagon Bootcamp'] },
    { name: 'SQL',                      category: 'digital', level: 60, years: 4, status: 'learning',
      evidence: ['Lisbon Data Science Academy'] },
    { name: 'Ruby / Rails',             category: 'digital', level: 50, years: 2, status: 'learning',
      evidence: ['Le Wagon Full Stack Bootcamp'] },
    { name: 'Git / version control',    category: 'digital', level: 50, years: 5, status: 'learning',
      evidence: ['Active site workflow', 'Le Wagon'] },
    { name: 'Full-stack basics',        category: 'digital', level: 50, years: 3, status: 'learning',
      evidence: ['Le Wagon Full Stack Bootcamp'] },
    { name: 'UI design',                category: 'digital', level: 50, years: 8, status: 'learning',
      evidence: ['Site design choices', 'SportSpots product UI'] },
    { name: 'UX design',                category: 'digital', level: 55, years: 8, status: 'learning',
      evidence: ['Innovation-driven design', 'Product work for SportSpots'] },
    { name: 'Vector / SVG',             category: 'digital', level: 55, years: 3, status: 'learning',
      evidence: ['This portfolio icon system', 'Design refinement'] },
    { name: 'Figma',                    category: 'digital', level: 45, years: 4, status: 'learning',
      evidence: ['Site mockups'] },
    ...
    { name: 'Multilingual (PT/EN/IT/FR)', category: 'soft', level: 85, years: 20, status: 'consolidated',
      evidence: ['Portuguese (native)', 'English C2 — TOEFL 110/120', 'Italian C2', 'French A1'] },
    { name: 'Industry Switching',       category: 'soft', level: 85, years: 20, status: 'consolidated',
      evidence: ['Energy, environment, automotive, water, sports tech', 'Research → consulting → corporate → startup'] },
    { name: 'Stakeholder Management',   category: 'soft', level: 85, years: 15, status: 'consolidated',
      evidence: ['Municipalities, grid operators, financial counterparties (Martifer)', 'Multi-entity AdP Group'] },
    { name: 'Lean Startup Mindset',     category: 'soft', level: 85, years: 7, status: 'consolidated',
      evidence: ['Implemented Eric Ries methodology at SmartEnergyLab'] },
    { name: 'Teaching / Knowledge transfer', category: 'soft', level: 80, years: 3, status: 'learning',
      evidence: ['Invited Professor — International Innovation Management, ISCTE Executive Education'] },
    { name: 'Agile Thinking',           category: 'soft', level: 80, years: 8, status: 'consolidated',
      evidence: ['Innovation methodology toolkit'] },
    { name: 'Design Thinking',          category: 'soft', level: 80, years: 8, status: 'consolidated',
      evidence: ['Innovation methodology toolkit'] },
    { name: 'Resilience (sport)',       category: 'soft', level: 80, years: 20, status: 'consolidated',
      evidence: ['Federated competitive swimmer — FPN', 'Marathon runner'] },
    { name: 'Risk Tolerance',           category: 'soft', level: 75, years: 6, status: 'consolidated',
      evidence: ['Co-founded SPORTSPOTS', 'Co-founded Ready2innov'] },
    { name: 'Mentorship',               category: 'soft', level: 70, years: 5, status: 'learning',
